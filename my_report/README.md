...
Τα πλεονεκτήματα της έτοιμης βιβλιοθήκης με την OpenCV είναι ότι, η διαδικασία γίνεται πιο εύκολη , η κάμερα αναλύει και εντοπίζει τα αντικείμενα της εικόνας και καταγράφει την κίνηση του σώματος και τη δείχνει. Τα αρνητικά της έτοιμης βιβλιοθήκης είναι ότι    
